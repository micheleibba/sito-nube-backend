        ...
        <div class="flex items-stretch">
            ...
            <div class="flex-1 p-5 flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition flex-shrink-0">
                    <a href="http://localhost:3000/blog/{{ $post->slug_en }}" target="_blank" class="p-2 rounded-lg text-surface-500 hover:text-emerald-400 hover:bg-emerald-500/5 transition" title="Anteprima">
